...
import { runScout, streamScout } from "../../lib/scout";
...
function eventPayload(event: import("../../lib/scout").ScoutEvent): unknown {
  switch (event.type) {
    case "stage":
...
// Re-export provider info for routes that want to surface it (kept here to
// avoid a barrel module).
export { getProviderInfo };
